...
import { PersonDtoPagedResultDto } from './dto/people/person-dto-paged-result-dto';

import * as moment from 'moment';
import { CreateContactDto } from './dto/contact-list/create-contact-dto';
import { ContactDto } from './dto/contact-list/contact-dto';
import { ContactDtoPagedResultDto } from './dto/contact-list/contact-dto-paged-result-dto';
...
export class ContactServiceProxy {
     ...
     * @return Success
     */
    create(body: CreateContactDto | undefined): Observable<ContactDto> {
     ...
     * @return Success
     */
    get(id: string | undefined): Observable<ContactDto> {
     ...
     * @return Success
     */
    getAll(keyword: string | undefined, isActive: boolean | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<ContactDtoPagedResultDto> {
    ...
    protected processGetAll(response: HttpResponseBase): Observable<ContactDtoPagedResultDto> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ContactDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
     ...
     * @return Success
     */
    update(body: ContactDto | undefined): Observable<ContactDto> {
...
export class PersonServiceProxy {
     ...
     * @return Success
     */
    getAll(keyword: string | undefined, isActive: boolean | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<PersonDtoPagedResultDto> {
