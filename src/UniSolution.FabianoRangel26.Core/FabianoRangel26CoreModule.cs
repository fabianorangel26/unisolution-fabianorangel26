...
using UniSolution.FabianoRangel26.Localization;
using UniSolution.FabianoRangel26.MultiTenancy;
using UniSolution.FabianoRangel26.Timing;
...
namespace UniSolution.FabianoRangel26
{
    ...
    public class FabianoRangel26CoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            FabianoRangel26LocalizationConfigurer.Configure(Configuration.Localization);
            ...
            SimpleStringCipher.DefaultPassPhrase = FabianoRangel26Consts.DefaultPassPhrase;
        }

        public override void Initialize()
        {
            IocManager.RegisterAssemblyByConvention(typeof(FabianoRangel26CoreModule).GetAssembly());
        }
